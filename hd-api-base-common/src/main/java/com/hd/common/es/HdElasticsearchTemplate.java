package com.hd.common.es;

import com.alibaba.fastjson.JSONArray;
import com.alibaba.fastjson.JSONObject;
import com.hd.common.util.RestUtil;
...
@Slf4j
@Component
public class HdElasticsearchTemplate {
    /**
     * es服务地址
     */
    ...
    public HdElasticsearchTemplate(@Value("${hd.elasticsearch.cluster-nodes}") String baseUrl, @Value("${hd.elasticsearch.check-enabled}") boolean checkEnabled) {
        log.debug("HdElasticsearchTemplate BaseURL：" + baseUrl);
