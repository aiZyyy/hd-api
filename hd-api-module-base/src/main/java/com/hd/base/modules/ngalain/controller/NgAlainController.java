package com.hd.base.modules.ngalain.controller;
...
import com.hd.base.modules.ngalain.service.NgAlainService;
...
public class NgAlainController {
    ...
    public JSONObject getAppData(HttpServletRequest request) throws Exception {
       String token=request.getHeader("X-Access-Token");
        ...
        app.put("name", "hd-boot-angular");
        app.put("description", "hd+ng-alain整合版本");
        j.put("app", app);
        return j;
    }
