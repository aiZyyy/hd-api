package com.hd.base.modules.system.model;
...
public class TreeModel implements Serializable {
	...
	public TreeModel(SysCategory sysCategory) {
		this.key = sysCategory.getId();
		this.parentId = sysCategory.getPid();
		this.title = sysCategory.getName();
		this.slotTitle =  sysCategory.getName();
		this.value = sysCategory.getId();
		this.isLeaf = sysCategory.isLeaf();
		this.label = sysCategory.getName();
