...
import com.hd.base.modules.system.mapper.SysPermissionMapper;
import com.hd.base.modules.system.mapper.SysRolePermissionMapper;
...
public class SysPermissionServiceImpl extends ServiceImpl<SysPermissionMapper, SysPermission> implements ISysPermissionService {
	...
	public void deletePermission(String id) throws HdBootException {
		...
		if(sysPermission==null) {
			throw new HdBootException("未找到菜单信息");
		}
