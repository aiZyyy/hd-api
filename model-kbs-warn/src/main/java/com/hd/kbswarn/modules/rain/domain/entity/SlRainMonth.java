 ...
 */
@Data
@TableName("sl_rain_month")
@EqualsAndHashCode(callSuper = false)
@Accessors(chain = true)
@ApiModel(value="sl_rain_month对象", description="月降雨量统计")
public class SlRainMonth {
	...
	/**月累计降雨量*/
	@Excel(name = "月累计降雨量", width = 15)
    @ApiModelProperty(value = "月累计降雨量")
