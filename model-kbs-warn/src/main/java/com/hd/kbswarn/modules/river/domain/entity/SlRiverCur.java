 ...
 */
@Data
@TableName("sl_river_cur")
@EqualsAndHashCode(callSuper = false)
@Accessors(chain = true)
@ApiModel(value = "sl_river_cur对象", description = "河道水情实时表")
public class SlRiverCur {
     ...
     * 累计过水量(立方米)
     */
    @Excel(name = "累计过水量(立方米)", width = 15)
    @ApiModelProperty(value = "累计过水量(立方米)")
